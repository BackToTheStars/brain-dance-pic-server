...
// результата. format_id — не только цифры: у DRC-дорожек суффикс '-drc'
// (например 'video.f140-drc.m4a'), поэтому \d+ здесь было бы дырой — такая
// дорожка не считалась бы сторожем размера и могла сойти за результат.
const TRACK_FILE_RE = /\.f[\w.-]+\.[^.]+(\.part)?$/;
